var nojscomponent = (function () {
    var elementReference = null;

    return {
        registerKeyListener: function (element) {
            elementReference = element;
            document.addEventListener('keydown', nojscomponent.onKeyDownEvent);
        },

        unRegisterKeyListener: function () {
            document.removeEventListener('keydown', nojscomponent.onKeyDownEvent);
